...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		function  delClick(id){
			...
			window.location="AddressServlet?action=delete&idStr="+id;
				...
				xmlhttprequest.onreadystatechange = function(){
					if(xmlhttprequest.readyState == 4){
						if(xmlhttprequest.status == 200){//正常执行的状态码
							...
							document.getElementById("singlePrice_"+id).innerText=arr[0].money;							
						}
					}
				}
				//建立连接
				xmlhttprequest.open("GET","ShopServlet?action=updateAjax&goodsInfoIdStr="+id+"&countStr=-1",true);
				//发送请求
				xmlhttprequest.send();
			}
		}
							...
							<c:forEach items="${addressList}" var="address">
								...
								>
										...
										<div class="new-addr-btn">
											...
											<a href="AddressServlet?action=initUpdate&idStr=${address.id}">编辑</a>
					...
					<c:forEach items="${shopCart.shopCartItemList}" var="shopCartItem">
								...
								<div class="bundle  bundle-last">
									...
									<div class="bundle-main">
										<ul class="item-content clearfix">
												...
												<li class="td td-item">
													<div class="item-pic">
														<a href="#" class="J_MakePoint">
															<img src="images/${shopCartItem.goodsInfo.goodsPic}" style="width: 80px; height: 80px" class="itempic J_ItemImg"></a>
													</div>
													<div class="item-info">
														<div class="item-basic-info">
															<a href="#" class="item-title J_MakePoint" data-point="tbcart.8.11">${shopCartItem.goodsInfo.goodsDescription}</a>
														</div>
													</div>
												</li>						
													...
													<div class="item-price price-promo-promo">
														<div class="price-content">
															<div class="price-line">
																<em class="price-original">${shopCartItem.goodsInfo.goodsPrice}</em>
															</div>
															<div class="price-line"> 
																<em class="J_Price price-now" id="priceNow" tabindex="0">${shopCartItem.goodsInfo.goodsPriceOff}</em>
															</div>
														</div>
													</div>
												</li>
											...
											<li class="td td-amount">
												<div class="amount-wrapper ">
													<div class="item-amount ">
														...
														<div class="sl">
															<input class="min am-btn" name="" type="button" value="-" onclick="jian(${shopCartItem.goodsInfo.id})"/> 
															<input class="text_box" id="count_${shopCartItem.goodsInfo.id}" type="text" value="${shopCartItem.count}" 
													          style="width: 30px; text-align: center;"/> 
													          <input class="add am-btn" name="" type="button" value="+"  onclick="jia(${shopCartItem.goodsInfo.id})"/>
											...
											<li class="td td-sum">
												<div class="td-inner">
													<em tabindex="0" class="J_ItemSum number"  id="singlePrice_${shopCartItem.goodsInfo.id}">${shopCartItem.money}</em>
												</div>
											</li>
							...
							<div class="order-go clearfix">
								<div class="pay-confirm clearfix">
                                    ...
                                    <span>¥</span> <em class="style-large-bold-red " id="J_ActualFee">${shopCart.allMoney}</em>
											</span>
										</div>
										...
										<div id="holyshit268" class="pay-address">
                                         ...
                                         <span class="buy-user" id="person">名字 </span>
												<span class="buy-phone" id="tel">电话</span>
												</span>
											</p>
										</div>
									</div>
									...
									<div id="holyshit269" class="submitOrder">
										...
										<form action="ShopServlet?action=submitOrder" method="post" id="form">
