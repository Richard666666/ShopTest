...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#LikBasket").click(function(){
			window.location = "ShopServlet?action=add&goodsInfoIdStr="+${goodsInfo.id}+"&countStr="+$('#value').val();
		})
			...
			<div class="clearfixLeft" id="clearcontent">
				...
				<div class="box">
					...
					<div class="tb-booth tb-pic tb-s310">
						<a href="#"><img src="images/${goodsInfo.goodsPic}"
				...
				<div class="tb-detail-list">
					...
					<div class="tb-detail-price">
						...
						<li class="price iteminfo_price">
							<dt>促销价</dt>
							<dd>
								<em>¥</em><b class="sys_item_price">${goodsInfo.goodsPriceOff}</b>
							</dd>
						</li>
						<li class="price iteminfo_mktprice">
							<dt>原价</dt>
							<dd>
								<em>¥</em><b class="sys_item_mktprice">${goodsInfo.goodsPrice}</b>
							</dd>
						</li>
						<div class="clear"></div>
					</div>
								...
								<div class="theme-popbod dform">
									<form class="theme-signin" action="" method="post">
										...
										<div class="theme-signin-left">
											...
											<div class="theme-options">
												...
												<dd>
													...
													<span class="stock" id="stock">${goodsInfo.goodsStock}</span>件
													</span>
												</dd>
										...
										<div class="theme-signin-right">
											...
											<div class="text-info">
												<span class="J_Price price-now">¥${goodsInfo.goodsPriceOff}</span> <span
													id="Stock" class="tb-hidden">库存<span class="stock">${goodsInfo.goodsStock}</span>件
												</span>
											</div>
										</div>
